...
G Trash the global checksum.`)
    ...
    .option('-m, --mbc <mbc>', 'Set the MBC type, 0x147, to a given value from 0 to 0xFF.')
    .option('-n, --rom-version <version>', 'Set the ROM version, 0x14C, to a given value from 0 to 0xFF.')
    ...
    .option('-r, --ram <ram_size>', 'Set the RAM size, 0x149, to a given value from 0 to 0xFF.')
